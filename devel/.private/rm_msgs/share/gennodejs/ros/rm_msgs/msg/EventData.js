...
class EventData {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.own_outpost_state = null;
      this.own_base_state = null;
      this.stamp = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('own_outpost_state')) {
        this.own_outpost_state = initObj.own_outpost_state
      }
      else {
        this.own_outpost_state = 0;
      }
      if (initObj.hasOwnProperty('own_base_state')) {
        this.own_base_state = initObj.own_base_state
      }
      else {
        this.own_base_state = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.small_power_rune_state, buffer, bufferOffset);
    // Serialize message field [large_power_rune_state]
    bufferOffset = _serializer.uint8(obj.large_power_rune_state, buffer, bufferOffset);
    ...
    // Serialize message field [own_outpost_state]
    bufferOffset = _serializer.uint8(obj.own_outpost_state, buffer, bufferOffset);
    // Serialize message field [own_base_state]
    bufferOffset = _serializer.uint8(obj.own_base_state, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.small_power_rune_state = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [large_power_rune_state]
    data.large_power_rune_state = _deserializer.uint8(buffer, bufferOffset);
    ...
    // Deserialize message field [own_outpost_state]
    data.own_outpost_state = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [own_base_state]
    data.own_base_state = _deserializer.uint8(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '8ed387c23f2e54ea4effe53751c292c5';
  }
  ...
  static messageDefinition() {
    ...
    uint8 small_power_rune_state
    uint8 large_power_rune_state
    ...
    uint8 own_outpost_state
    uint8 own_base_state
  ...
  static Resolve(msg) {
    ...
    if (msg.small_power_rune_state !== undefined) {
      ...
      resolved.small_power_rune_state = 0
    }
    ...
    if (msg.large_power_rune_state !== undefined) {
      ...
      resolved.large_power_rune_state = 0
    }
    ...
    if (msg.own_outpost_state !== undefined) {
      resolved.own_outpost_state = msg.own_outpost_state;
    }
    else {
      resolved.own_outpost_state = 0
    }

    if (msg.own_base_state !== undefined) {
      resolved.own_base_state = msg.own_base_state;
    }
    else {
      resolved.own_base_state = 0
    }
