...
class RfidStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.own_assemble_point = null;
      this.enemy_assemble_point = null;
      this.central_buff_point = null;
      this.enemy_fort_buff_point = null;
      this.enemy_outpost_buff_point = null;
      this.below_road_tunnel_own_terrain_span_buff_point_state = null;
      this.upper_road_tunnel_own_terrain_span_buff_point_state = null;
      this.below_trapezoidal_tunnel_own_terrain_span_buff_point_state = null;
      this.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state = null;
      this.below_road_tunnel_enemy_terrain_span_buff_point_state = null;
      this.upper_road_tunnel_enemy_terrain_span_buff_point_state = null;
      this.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = null;
      this.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = null;
      this.stamp = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('own_assemble_point')) {
        this.own_assemble_point = initObj.own_assemble_point
      }
      else {
        this.own_assemble_point = false;
      }
      if (initObj.hasOwnProperty('enemy_assemble_point')) {
        this.enemy_assemble_point = initObj.enemy_assemble_point
      }
      else {
        this.enemy_assemble_point = false;
      }
      ...
      if (initObj.hasOwnProperty('enemy_fort_buff_point')) {
        this.enemy_fort_buff_point = initObj.enemy_fort_buff_point
      }
      else {
        this.enemy_fort_buff_point = false;
      }
      if (initObj.hasOwnProperty('enemy_outpost_buff_point')) {
        this.enemy_outpost_buff_point = initObj.enemy_outpost_buff_point
      }
      else {
        this.enemy_outpost_buff_point = false;
      }
      if (initObj.hasOwnProperty('below_road_tunnel_own_terrain_span_buff_point_state')) {
        this.below_road_tunnel_own_terrain_span_buff_point_state = initObj.below_road_tunnel_own_terrain_span_buff_point_state
      }
      else {
        this.below_road_tunnel_own_terrain_span_buff_point_state = false;
      }
      if (initObj.hasOwnProperty('upper_road_tunnel_own_terrain_span_buff_point_state')) {
        this.upper_road_tunnel_own_terrain_span_buff_point_state = initObj.upper_road_tunnel_own_terrain_span_buff_point_state
      }
      else {
        this.upper_road_tunnel_own_terrain_span_buff_point_state = false;
      }
      if (initObj.hasOwnProperty('below_trapezoidal_tunnel_own_terrain_span_buff_point_state')) {
        this.below_trapezoidal_tunnel_own_terrain_span_buff_point_state = initObj.below_trapezoidal_tunnel_own_terrain_span_buff_point_state
      }
      else {
        this.below_trapezoidal_tunnel_own_terrain_span_buff_point_state = false;
      }
      if (initObj.hasOwnProperty('upper_trapezoidal_tunnel_own_terrain_span_buff_point_state')) {
        this.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state = initObj.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state
      }
      else {
        this.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state = false;
      }
      if (initObj.hasOwnProperty('below_road_tunnel_enemy_terrain_span_buff_point_state')) {
        this.below_road_tunnel_enemy_terrain_span_buff_point_state = initObj.below_road_tunnel_enemy_terrain_span_buff_point_state
      }
      else {
        this.below_road_tunnel_enemy_terrain_span_buff_point_state = false;
      }
      if (initObj.hasOwnProperty('upper_road_tunnel_enemy_terrain_span_buff_point_state')) {
        this.upper_road_tunnel_enemy_terrain_span_buff_point_state = initObj.upper_road_tunnel_enemy_terrain_span_buff_point_state
      }
      else {
        this.upper_road_tunnel_enemy_terrain_span_buff_point_state = false;
      }
      if (initObj.hasOwnProperty('below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state')) {
        this.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = initObj.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state
      }
      else {
        this.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = false;
      }
      if (initObj.hasOwnProperty('upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state')) {
        this.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = initObj.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state
      }
      else {
        this.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [own_assemble_point]
    bufferOffset = _serializer.bool(obj.own_assemble_point, buffer, bufferOffset);
    // Serialize message field [enemy_assemble_point]
    bufferOffset = _serializer.bool(obj.enemy_assemble_point, buffer, bufferOffset);
    // Serialize message field [central_buff_point]
    bufferOffset = _serializer.bool(obj.central_buff_point, buffer, bufferOffset);
    // Serialize message field [enemy_fort_buff_point]
    bufferOffset = _serializer.bool(obj.enemy_fort_buff_point, buffer, bufferOffset);
    // Serialize message field [enemy_outpost_buff_point]
    bufferOffset = _serializer.bool(obj.enemy_outpost_buff_point, buffer, bufferOffset);
    // Serialize message field [below_road_tunnel_own_terrain_span_buff_point_state]
    bufferOffset = _serializer.bool(obj.below_road_tunnel_own_terrain_span_buff_point_state, buffer, bufferOffset);
    // Serialize message field [upper_road_tunnel_own_terrain_span_buff_point_state]
    bufferOffset = _serializer.bool(obj.upper_road_tunnel_own_terrain_span_buff_point_state, buffer, bufferOffset);
    // Serialize message field [below_trapezoidal_tunnel_own_terrain_span_buff_point_state]
    bufferOffset = _serializer.bool(obj.below_trapezoidal_tunnel_own_terrain_span_buff_point_state, buffer, bufferOffset);
    // Serialize message field [upper_trapezoidal_tunnel_own_terrain_span_buff_point_state]
    bufferOffset = _serializer.bool(obj.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state, buffer, bufferOffset);
    // Serialize message field [below_road_tunnel_enemy_terrain_span_buff_point_state]
    bufferOffset = _serializer.bool(obj.below_road_tunnel_enemy_terrain_span_buff_point_state, buffer, bufferOffset);
    // Serialize message field [upper_road_tunnel_enemy_terrain_span_buff_point_state]
    bufferOffset = _serializer.bool(obj.upper_road_tunnel_enemy_terrain_span_buff_point_state, buffer, bufferOffset);
    // Serialize message field [below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state]
    bufferOffset = _serializer.bool(obj.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state, buffer, bufferOffset);
    // Serialize message field [upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state]
    bufferOffset = _serializer.bool(obj.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [own_assemble_point]
    data.own_assemble_point = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [enemy_assemble_point]
    data.enemy_assemble_point = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [central_buff_point]
    data.central_buff_point = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [enemy_fort_buff_point]
    data.enemy_fort_buff_point = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [enemy_outpost_buff_point]
    data.enemy_outpost_buff_point = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [below_road_tunnel_own_terrain_span_buff_point_state]
    data.below_road_tunnel_own_terrain_span_buff_point_state = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [upper_road_tunnel_own_terrain_span_buff_point_state]
    data.upper_road_tunnel_own_terrain_span_buff_point_state = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [below_trapezoidal_tunnel_own_terrain_span_buff_point_state]
    data.below_trapezoidal_tunnel_own_terrain_span_buff_point_state = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [upper_trapezoidal_tunnel_own_terrain_span_buff_point_state]
    data.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [below_road_tunnel_enemy_terrain_span_buff_point_state]
    data.below_road_tunnel_enemy_terrain_span_buff_point_state = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [upper_road_tunnel_enemy_terrain_span_buff_point_state]
    data.upper_road_tunnel_enemy_terrain_span_buff_point_state = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state]
    data.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state]
    data.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = _deserializer.bool(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '1d620dd9d4d1f4fe120eb6f856b4e2c8';
  }
  ...
  static messageDefinition() {
    ...
    bool own_assemble_point
    bool enemy_assemble_point
    bool central_buff_point
    bool enemy_fort_buff_point
    bool enemy_outpost_buff_point
    bool below_road_tunnel_own_terrain_span_buff_point_state
    bool upper_road_tunnel_own_terrain_span_buff_point_state
    bool below_trapezoidal_tunnel_own_terrain_span_buff_point_state
    bool upper_trapezoidal_tunnel_own_terrain_span_buff_point_state
    bool below_road_tunnel_enemy_terrain_span_buff_point_state
    bool upper_road_tunnel_enemy_terrain_span_buff_point_state
    bool below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state
    bool upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state
  ...
  static Resolve(msg) {
    ...
    if (msg.own_assemble_point !== undefined) {
      resolved.own_assemble_point = msg.own_assemble_point;
    }
    else {
      resolved.own_assemble_point = false
    }

    if (msg.enemy_assemble_point !== undefined) {
      resolved.enemy_assemble_point = msg.enemy_assemble_point;
    }
    else {
      resolved.enemy_assemble_point = false
    }
    ...
    if (msg.enemy_fort_buff_point !== undefined) {
      resolved.enemy_fort_buff_point = msg.enemy_fort_buff_point;
    }
    else {
      resolved.enemy_fort_buff_point = false
    }

    if (msg.enemy_outpost_buff_point !== undefined) {
      resolved.enemy_outpost_buff_point = msg.enemy_outpost_buff_point;
    }
    else {
      resolved.enemy_outpost_buff_point = false
    }

    if (msg.below_road_tunnel_own_terrain_span_buff_point_state !== undefined) {
      resolved.below_road_tunnel_own_terrain_span_buff_point_state = msg.below_road_tunnel_own_terrain_span_buff_point_state;
    }
    else {
      resolved.below_road_tunnel_own_terrain_span_buff_point_state = false
    }

    if (msg.upper_road_tunnel_own_terrain_span_buff_point_state !== undefined) {
      resolved.upper_road_tunnel_own_terrain_span_buff_point_state = msg.upper_road_tunnel_own_terrain_span_buff_point_state;
    }
    else {
      resolved.upper_road_tunnel_own_terrain_span_buff_point_state = false
    }

    if (msg.below_trapezoidal_tunnel_own_terrain_span_buff_point_state !== undefined) {
      resolved.below_trapezoidal_tunnel_own_terrain_span_buff_point_state = msg.below_trapezoidal_tunnel_own_terrain_span_buff_point_state;
    }
    else {
      resolved.below_trapezoidal_tunnel_own_terrain_span_buff_point_state = false
    }

    if (msg.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state !== undefined) {
      resolved.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state = msg.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state;
    }
    else {
      resolved.upper_trapezoidal_tunnel_own_terrain_span_buff_point_state = false
    }

    if (msg.below_road_tunnel_enemy_terrain_span_buff_point_state !== undefined) {
      resolved.below_road_tunnel_enemy_terrain_span_buff_point_state = msg.below_road_tunnel_enemy_terrain_span_buff_point_state;
    }
    else {
      resolved.below_road_tunnel_enemy_terrain_span_buff_point_state = false
    }

    if (msg.upper_road_tunnel_enemy_terrain_span_buff_point_state !== undefined) {
      resolved.upper_road_tunnel_enemy_terrain_span_buff_point_state = msg.upper_road_tunnel_enemy_terrain_span_buff_point_state;
    }
    else {
      resolved.upper_road_tunnel_enemy_terrain_span_buff_point_state = false
    }

    if (msg.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state !== undefined) {
      resolved.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = msg.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state;
    }
    else {
      resolved.below_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = false
    }

    if (msg.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state !== undefined) {
      resolved.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = msg.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state;
    }
    else {
      resolved.upper_trapezoidal_tunnel_enemy_terrain_span_buff_point_state = false
    }
