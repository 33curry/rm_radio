...
class DartRemainingTime {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('dart_aim_state')) {
        this.dart_aim_state = initObj.dart_aim_state
      }
      else {
        this.dart_aim_state = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [dart_aim_state]
    bufferOffset = _serializer.uint8(obj.dart_aim_state, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [dart_aim_state]
    data.dart_aim_state = _deserializer.uint8(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.dart_aim_state !== undefined) {
      resolved.dart_aim_state = msg.dart_aim_state;
    }
    else {
      resolved.dart_aim_state = 0
    }
