...
(cl:defclass <EventData> (roslisp-msg-protocol:ros-message)
  ((overlapping_supply_station_state
   ...
   (own_fortress_state
    ...
    :initform 0)
   (own_outpost_state
    :reader own_outpost_state
    :initarg :own_outpost_state
    :type cl:fixnum
    :initform 0)
   (own_base_state
    :reader own_base_state
    :initarg :own_base_state
    :type cl:fixnum
    :initform 0)
   (stamp
    :reader stamp
...
(cl:ensure-generic-function 'own_outpost_state-val :lambda-list '(m))
(cl:defmethod own_outpost_state-val ((m <EventData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_msgs-msg:own_outpost_state-val is deprecated.  Use rm_msgs-msg:own_outpost_state instead.")
  (own_outpost_state m))

(cl:ensure-generic-function 'own_base_state-val :lambda-list '(m))
(cl:defmethod own_base_state-val ((m <EventData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_msgs-msg:own_base_state-val is deprecated.  Use rm_msgs-msg:own_base_state instead.")
  (own_base_state m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EventData>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'small_power_rune_state)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'large_power_rune_state)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'own_outpost_state)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'own_base_state)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EventData>) istream)
  "Deserializes a message object of type '<EventData>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'small_power_rune_state)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'large_power_rune_state)) (cl:read-byte istream))
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'own_outpost_state)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'own_base_state)) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EventData>)))
  ...
  "8ed387c23f2e54ea4effe53751c292c5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EventData)))
  "Returns md5sum for a message object of type 'EventData"
  "8ed387c23f2e54ea4effe53751c292c5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EventData>)))
  ...
  (cl:format cl:nil "bool overlapping_supply_station_state~%bool nan_overlapping_supply_station_state~%bool supplier_zone_state~%uint8 small_power_rune_state~%uint8 large_power_rune_state~%uint8 central_elevated_ground_state~%uint8 trapezoidal_elevated_ground_state~%uint16 be_hit_time~%uint8 be_hit_target~%uint8 central_point_state~%uint8 own_fortress_state~%uint8 own_outpost_state~%uint8 own_base_state~%~%~%time stamp~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EventData)))
  "Returns full string definition for message of type 'EventData"
  (cl:format cl:nil "bool overlapping_supply_station_state~%bool nan_overlapping_supply_station_state~%bool supplier_zone_state~%uint8 small_power_rune_state~%uint8 large_power_rune_state~%uint8 central_elevated_ground_state~%uint8 trapezoidal_elevated_ground_state~%uint16 be_hit_time~%uint8 be_hit_target~%uint8 central_point_state~%uint8 own_fortress_state~%uint8 own_outpost_state~%uint8 own_base_state~%~%~%time stamp~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EventData>))
  ...
  (cl:list 'EventData
    ...
    (cl:cons ':own_outpost_state (own_outpost_state msg))
    (cl:cons ':own_base_state (own_base_state msg))
