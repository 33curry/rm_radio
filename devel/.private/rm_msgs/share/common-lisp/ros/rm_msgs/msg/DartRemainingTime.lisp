...
(cl:defclass <DartRemainingTime> (roslisp-msg-protocol:ros-message)
  ((dart_remaining_time
    ...
    :initform 0)
   (dart_aim_state
    :reader dart_aim_state
    :initarg :dart_aim_state
    :type cl:fixnum
    :initform 0)
   (stamp
    :reader stamp
...
(cl:ensure-generic-function 'dart_aim_state-val :lambda-list '(m))
(cl:defmethod dart_aim_state-val ((m <DartRemainingTime>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_msgs-msg:dart_aim_state-val is deprecated.  Use rm_msgs-msg:dart_aim_state instead.")
  (dart_aim_state m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DartRemainingTime>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'dart_aim_state)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DartRemainingTime>) istream)
  "Deserializes a message object of type '<DartRemainingTime>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'dart_aim_state)) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DartRemainingTime>)))
  ...
  "40d1131bd0200d00e18b05056bb34441")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DartRemainingTime)))
  "Returns md5sum for a message object of type 'DartRemainingTime"
  "40d1131bd0200d00e18b05056bb34441")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DartRemainingTime>)))
  ...
  (cl:format cl:nil "uint8 dart_remaining_time~%uint8 dart_aim_state~%~%time stamp~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DartRemainingTime)))
  "Returns full string definition for message of type 'DartRemainingTime"
  (cl:format cl:nil "uint8 dart_remaining_time~%uint8 dart_aim_state~%~%time stamp~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DartRemainingTime>))
  ...
  (cl:list 'DartRemainingTime
    ...
    (cl:cons ':dart_aim_state (dart_aim_state msg))
