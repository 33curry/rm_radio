...
class ChassisCmd(genpy.Message):
  _md5sum = "6bcfa2b25e81c962c6246cce353f3437"
...
float64 z"""
  ...
  __slots__ = ['mode','accel','power_limit','follow_vel_des','follow_source_frame','command_source_frame','stamp']
  _slot_types = ['uint8','geometry_msgs/Accel','float64','float64','string','string','time']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       mode,accel,power_limit,follow_vel_des,follow_source_frame,command_source_frame,stamp
    ...
    if args or kwds:
      ...
      if self.power_limit is None:
        self.power_limit = 0.
      if self.follow_vel_des is None:
        self.follow_vel_des = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B8d().pack(_x.mode, _x.accel.linear.x, _x.accel.linear.y, _x.accel.linear.z, _x.accel.angular.x, _x.accel.angular.y, _x.accel.angular.z, _x.power_limit, _x.follow_vel_des))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mode, _x.accel.linear.x, _x.accel.linear.y, _x.accel.linear.z, _x.accel.angular.x, _x.accel.angular.y, _x.accel.angular.z, _x.power_limit, _x.follow_vel_des,) = _get_struct_B8d().unpack(str[start:end])
      start = end
      end += 4
